...
// ===== US Geography Quiz =====
// CST-336 Internet Programming - Cao
...
function gradeQuiz() {
    ...
    // Q3 - checkboxes (Jefferson + Roosevelt, and Washington + Lincoln not listed,
    //      so correct = Jefferson & Roosevelt checked, others unchecked)
    ...
    if (score > 80) {
        document.querySelector("#congratsMsg").textContent =
            "Congratulations! You really know your US geography!";
    }
